...
/**
 * Class VetrinaSvizzeraShortcode
 *
 * Handles the [aos_generi_svizzera] shortcode.
 */
class VetrinaSvizzeraShortcode {
    /**
    ...
    public function register() {
        add_shortcode( 'aos_generi_svizzera', [ $this, 'render' ] );
    }
    ...
    public function render( $atts ) {
        ...
        if ( is_wp_error( $all_numerazioni ) || empty( $all_numerazioni ) || is_wp_error( $all_generi ) || empty( $all_generi ) ) {
            return '';
        }
        ...
        foreach ( $all_numerazioni as $numerazione ) {
